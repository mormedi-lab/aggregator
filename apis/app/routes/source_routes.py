...
def save_sources(project_id: str, sources: List[Source])-> dict:
...
def add_source_to_library(project_id: str, body: AddToLibraryRequest)-> dict:
...
async def add_curated_source_and_link_to_library(project_id: str, body: CuratedSourceRequest) -> dict:
