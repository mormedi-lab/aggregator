...
export default function NewResearchSpaceModal({ isOpen, onClose, projectId, projectIndustries }: NewResearchSpaceModalProps) {
  ...
  useEffect(() => {
    if (isOpen && typeof projectIndustries === "string") {
          ...
          <>
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                className="w-full border border-[#E0D8CF] rounded-md px-4 py-[12px] text-sm placeholder-[#827F7F] text-[#2D2114]"
              />
            </div>
            ...
            <div className="flex justify-end">
              <button
                ...
                className={`px-6 py-[10px] rounded-md text-sm font-medium shadow-sm transition ${
                  isFormValid
                    ? "bg-[#FF5400] hover:bg-[#ff6a1a] text-white"
        ...
        {step === 2 && (
          <>
            ...
            <div className="flex justify-between mt-6">
              <button
                onClick={() => setStep(1)}
                className="px-6 py-[10px] rounded-md text-sm text-[#2D2114] border border-[#E0D8CF] hover:bg-[#FAF9F5]"
              >
                Back
              </button>
              <button
                onClick={handleSubmit}
                className="px-6 py-[10px] rounded-md text-sm font-medium shadow-sm bg-[#FF5400] hover:bg-[#ff6a1a] text-white"
              >
                Generate Sources
              </button>
            </div>
